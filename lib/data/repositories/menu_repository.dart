...
class MenuRepository {
  ...
  Future<int> addCategory(CategoriesCompanion category) async {
    ...
    // Push upstream
    try {
      // SyncService createCategory expects a CategoriesCompanion,
      // but maybe better to send full object if possible?
      // Actually SyncService.createCategory handles using keys.
      // We might want to ensure ID is handled if generated by server?
      // Current impl creates locally first.
      await syncService.createCategory(category);
    } catch (e) {
  ...
  Future<int> addItem(MenuItemsCompanion item) async {
    ...
    try {
      await syncService.createMenuItem(item);
    } catch (e) {
